...
const ExpandableButton = ({ onClick, expanded = false, children }) => {
    return (React__default["default"].createElement(IconButton, { "aria-label": "Hide or show expandable content", onClick: onClick },
        children,
        expanded ? React__default["default"].createElement(Icon$3F, { color: "invertedContrast" }) : React__default["default"].createElement(Icon$3M, { color: "invertedContrast" })));
};
const ExpandableLabel = ({ onClick, expanded = false, children }) => {
    return (React__default["default"].createElement(Button, { variant: exports.ButtonVariants.TEXT, "aria-label": "Hide or show expandable content", onClick: onClick, endIcon: expanded ? React__default["default"].createElement(Icon$3F, { color: "primary" }) : React__default["default"].createElement(Icon$3M, { color: "primary" }) }, children));
};
...
const QuestionWrapper = styled__default["default"](Flex) `
  ...
  ${({ showTooltip }) => showTooltip &&
    ...
    `}
`;
const TooltipHelper = ({ text, placement = "auto", size = "16px", color = "pastelBlue", trigger, Icon = Icon$31, ml = "4px", children, showTooltip = true, isLight = false, ...props }) => {
...
`;
const StyledChevronIcon = styled__default["default"](({ ...props }) => React__default["default"].createElement(Icon$3M, { ...props })) `
        ...
        React__default["default"].createElement(Wrapper, null,
            ...
            React__default["default"].createElement(BodyWrapper, null,
                React__default["default"].createElement(Inner, { isPushed: false, showMenu: showMenu },
                    React__default["default"].createElement(React__default["default"].Fragment, null,
                        children,
                        showFooter && (React__default["default"].createElement(Footer, { BSWPriceLabel: BSWPriceLabel, BSWPriceValue: BSWPriceValue, registerToken: registerToken, buyBswHandler: buyBswHandler, aboutLinks: aboutLinks, moreLinks: moreLinks, infoLinks: infoLinks, productLinks: productLinks, serviceLinks: serviceLinks, socialLinks: socialLinks, marketplaceLink: marketplaceLink, baseAwsUrl: baseAwsUrl, buyBswLabel: buyBswLabel }))))))));
};
