...
const ExpandableButton = ({ onClick, expanded = false, children }) => {
    return (React__default["default"].createElement(IconButton, { "aria-label": "Hide or show expandable content", onClick: onClick },
        children,
        expanded ? React__default["default"].createElement(Icon$3K, { color: "invertedContrast" }) : React__default["default"].createElement(Icon$3R, { color: "invertedContrast" })));
};
const ExpandableLabel = ({ onClick, expanded = false, children }) => {
    return (React__default["default"].createElement(Button, { variant: exports.ButtonVariants.TEXT, "aria-label": "Hide or show expandable content", onClick: onClick, endIcon: expanded ? React__default["default"].createElement(Icon$3K, { color: "primary" }) : React__default["default"].createElement(Icon$3R, { color: "primary" }) }, children));
};
...
const LinkExternal = ({ children, ...props }) => {
    return (React__default["default"].createElement(Link, { external: true, ...props },
        children,
        React__default["default"].createElement(Icon$3D, { color: props.color ? props.color : "primary", width: "16px", ml: "4px" })));
};
...
const QuestionWrapper = styled__default["default"](Flex) `
  ...
  ${({ showTooltip }) => showTooltip &&
    ...
    `}
`;
const TooltipHelper = ({ text, placement = "auto", size = "16px", color = "pastelBlue", trigger, Icon = Icon$36, ml = "4px", children, showTooltip = true, isLight = false, ...props }) => {
...
`;
const StyledChevronIcon = styled__default["default"](({ ...props }) => React__default["default"].createElement(Icon$3R, { ...props })) `
            ...
            React__default["default"].createElement(Alert, { progress: progress, title: title, variant: alertTypeMap[type], onClick: handleRemove },
                React__default["default"].createElement(Box, null,
                    scanLink && (React__default["default"].createElement(LinkWrapper, null,
                        ...
                        React__default["default"].createElement(Icon$3D, { width: "18px", height: "18px", ml: "6px", color: "primary" }))),
