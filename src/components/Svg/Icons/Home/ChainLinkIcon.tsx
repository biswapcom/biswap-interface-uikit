  ...
  return (
    <Svg viewBox="0 0 40 40" fill="currentColor" {...props}>
      ...
      <path
        ...
        stroke="#004ACC" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
      <path
        ...
        stroke="#004ACC" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M15.62 22.62L16.5 21L17.38 22.62L19 23.5L17.38 24.38L16.5 26L15.62 24.38L14 23.5L15.62 22.62Z"
            stroke="#004ACC" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    </Svg>
  );
};
