...
import Community from "../../../../Menu/components/Footer/Community";
import Marker from "../../MenuItem/Marker";
import { HeadText, Scales } from "../../../../../components/Typography";
...
const MobileMenu: FC<MobileMenuProps> = ({ items, mobileMenuCallback, children, activeItem, baseAwsUrl, ...props }) => {
